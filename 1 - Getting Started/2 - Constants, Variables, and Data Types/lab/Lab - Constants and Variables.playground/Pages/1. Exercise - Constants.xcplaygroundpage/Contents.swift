 ...
 */
print("You cannot change the value of friends because it is a constant. Trying to change its value after it was already assigned will result in a compiler error.")
